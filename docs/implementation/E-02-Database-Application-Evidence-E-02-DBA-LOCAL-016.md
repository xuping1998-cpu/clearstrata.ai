# E-02 Database Application Evidence — E-02-DBA-LOCAL-016

| Field | Value |
|-------|-------|
| **Document Type** | Database Application Evidence (Successor) |
| **Program** | E-02 — Freeze Engine · Executable Remediation Stage |
| **Authorization ID** | **E-02-DBA-LOCAL-016** |
| **Authorization Reference** | [`E-02-Database-Application-Authorization-LOCAL-016.md`](E-02-Database-Application-Authorization-LOCAL-016.md) v1.0 |
| **BCR Artifact Authority** | [`E-02-Baseline-Compatibility-Replay-Implementation-Authorization-016.md`](E-02-Baseline-Compatibility-Replay-Implementation-Authorization-016.md) (E-02-BCR-IA-016 **CONSUMED**) · [`E-02-Baseline-Compatibility-Replay-Implementation-Completion-016.md`](E-02-Baseline-Compatibility-Replay-Implementation-Completion-016.md) (**E-02-BCR-IMPLEMENTATION-COMPLETION-016** · **COMPLETED WITH NOTES**) |
...
| **Predecessor DBA / evidence** | **E-02-DBA-LOCAL-015** — [`E-02-Database-Application-Evidence-E-02-DBA-LOCAL-015.md`](E-02-Database-Application-Evidence-E-02-DBA-LOCAL-015.md) · **APPLICATION_FAILED / NOT SUCCESSFULLY CONSUMED / EVIDENCE IMMUTABLE** — **not reclassified** · **not overwritten** |
| **Status** | **Issued — first and only stateful apply — APPLICATION_FAILED** |
| **Revision** | v1.0 |
| **Effective Date** | 2026-08-30 |
| **Production Effect** | **None** |

> **Controlling result:** `APPLICATION_FAILED`. Pre-stateful gates **PASS**. Stateful `--apply --preserve-environment` **started once**. **No retry. No second apply. No LOCAL-017. No source repair.**
...
FAILURE TEXT                            = column mv.meeting_id does not exist
STATEFUL APPLY STARTED                  = YES
STATEFUL APPLY ATTEMPT COUNT            = 1
AUTHORIZATION CONSUMED                  = NO (E-02-DBA-LOCAL-016 NOT SUCCESSFULLY CONSUMED)
EVIDENCE                                = IMMUTABLE
...
NEW FAILURE vs HMD-001..009             = YES (same target file; different error; not classified / not remediated)
```
...
| Path | Action |
|------|--------|
| `docs/implementation/E-02-Database-Application-Evidence-E-02-DBA-LOCAL-016.md` | **Created** (this document) |
| `docs/implementation/README.md` | **Minimally updated** |
| `tests/e02/evidence/local-016-20260830a/bcr-replay-manifest.json` | **Created by BCR apply** (not hand-edited) |

**Not modified:** replay artifact · verifier · environment guard · `package.json` · migrations · HMD-009 reconstruction · HMD-009 target · HMD-008 target · HMD-007 target · HMD-006 target · HMD-005 reconstruction · HMD-005 target · W1 · W2 · HMD-002 restored file · HMD-004 restored file · April HARD · July S1 · tests · CB-B · launcher · diagnostics · Docker configuration · LOCAL-015 evidence · earlier evidence.

**Not created:** LOCAL-017 · REA · EIR · HMD-010.

**Not overwritten:** LOCAL-015 or earlier evidence.
...
| Gate | Result |
|------|--------|
| A authority documents | **PASS** — LOCAL-016 **APPROVED WITH CONDITIONS / NOT CONSUMED / NOT EXECUTED / EXECUTION GATED**; attempts **0**; future apply **EXACTLY 1**; IA-016 **CONSUMED**; Completion-016 **COMPLETED WITH NOTES**; BCR **RETARGETED TO LOCAL-016 / ARTIFACT AUTHORITY E-02-BCR-IA-016 / IMPLEMENTATION COMPLETED / STATICALLY CERTIFIED** |
| B LOCAL-016 attempts | **PASS** — **0** before apply (no LOCAL-016 evidence file; no `tests/e02/evidence/local-016-*` before this run) |
| C BCR pins | **PASS** — `EXPECTED_DBA_AUTHORIZATION_ID=E-02-DBA-LOCAL-016` · `ARTIFACT_AUTHORIZATION_ID=E-02-BCR-IA-016` |
| D exact-match | **PASS** — `raw !== EXPECTED_DBA_AUTHORIZATION_ID` retained · dual-accept **NONE** · LOCAL-015 operational acceptance **NO** · IA-015 operational artifact authority **NO** |
| E predecessor | **PASS** — LOCAL-015 **APPLICATION_FAILED / EVIDENCE IMMUTABLE** · attempts **1** · retry **NOT AUTHORIZED** · evidence run `local-015-20260829a` **not reused** |
| F HMD-009 static | **PASS** — **OPEN / OPTION B / RECONSTRUCTION IMPLEMENTED / IMPLEMENTATION COMPLETED / RUNTIME REPLAY VERIFICATION PENDING** (pre-apply) · HFSOR Completion-003 **COMPLETED WITH NOTES** · reconstruction and target **not edited** this task |
| G HMD-008 / HMD-007 / HMD-006 / HMD-005 / HMD-003 locks | **PASS** — HMD-008 **RUNTIME REPLAY VERIFIED** · HMD-007 **RUNTIME REPLAY VERIFIED** · HMD-006 **RUNTIME REPLAY VERIFIED** · HMD-005 **RUNTIME REPLAY VERIFIED** · HMD-003 **RUNTIME REPLAY VERIFICATION PENDING** · targets **not edited** |
| H quarantine | **PASS** — exactly `20260314195641_add_demo_data.sql` / **COUNT 1** · HMD-009 reconstruction/target **not quarantined** |
| I worktree | **PASS** — executable diffs limited to authorized BCR pin lineage through IA-016 · HMD-005 reconstruction · HMD-006/007/008 restorations · HMD-009 reconstruction · governance documentation · verifier/guard/package/tests/app **clean** · **UNEXPLAINED EXECUTABLE DRIFT = NONE** |
| J fresh `--plan` | **PASS** — `PLAN_OK` · `startedAt` `2026-08-30T20:36:23.649Z` · failures `[]` |
| K checkpoints in plan/source | **PASS** — HMD-009 recon+target · W2 · April HARD · July S1 **DISCOVERED / EXECUTABLE**; quarantine **DISCOVERED / QUARANTINED**; HMD-009 recon+target **NOT QUARANTINED** |
| L fresh build | **PASS** — `npm run build` exit **0** · Vite **5.4.21** · **3333** modules · **16.34s** (duration non-normative) |
| M env authority (apply path) | **PASS** — set only for apply: DBA **LOCAL-016** · apply `true` · destructive-tests `true` (technical fail-closed only) · evidence env `local` · runtime-execution **UNSET** · baseline-verification **UNSET** · runId **`local-016-20260830a`** (not `local-015-20260829a`) |
...
| O Docker | **PASS** — Client **29.7.2** · Server Engine **29.7.2** · Desktop **4.87.0** · containers running **0** / all **0** · version probe **179 ms** |
| P disposable DB pre-state | **PASS** — LOCAL-015 failed runtime **not reused** · no leftover containers · no manual DDL · no fake history |
...
PRE_STATEFUL                       = PASSED
LOCAL-016 APPLY                    = AUTHORIZED TO START
```
...
| Variable | Value |
|----------|-------|
| `E02_EVIDENCE_RUN_ID` | **`local-016-20260830a`** (fresh; unused before this apply; **not** `local-015-20260829a`) |
| `E02_DBA_AUTHORIZATION_ID` | `E-02-DBA-LOCAL-016` (exact match; `validatedDbaAuthorizationId` same) |
...
Guard stdout: `[e02-guard] evidenceRunId=local-016-20260830a env=local projectRef=127.0.0.1 host=127.0.0.1:54321`
...
At apply start: **LOCAL-016 STATEFUL APPLY ATTEMPTS 0 → 1** (irreversible).
...
| APPLY_START | `2026-08-30T13:37:09.3880918-07:00` |
| APPLY_FINISH | `2026-08-30T13:38:16.9021356-07:00` |
| Manifest startedAt / finishedAt | `2026-08-30T20:37:10.103Z` / `2026-08-30T20:38:16.772Z` |
| APPLY_EXIT | **1** |
...
| Field | Value |
|-------|-------|
| Auxiliary workdir (sanitized) | `<OS_TMP>/e02-bcr-aux-local-016-20260830a` |
...
LOCAL-015 previously failed at executable index **73** (`20260405120000`) with `relation "public.hiring_jobs" does not exist`. This run inserted reconstruction immediately before that target. Executed **73**, so reconstruction **index 73 applied**, then the same target failed at **index 74** with a **different** error.

This first-failing error is **FORENSICALLY NOTED / NOT CLASSIFIED / NOT REPAIRED / NOT ALLOCATED**. **No HMD-010. No remediation. STOP → GOVERNANCE.**

Immediate predecessor that applied: `20260404120000_create_leads.sql` (index **72**) then reconstruction `20260405115900_hmd009_reconstruct_hiring_jobs.sql` (index **73**). Immediate successor after the failing target (`20260405120100_multi_tenant_rls.sql`) was **NOT REACHED**.
...
## 14. HMD-009 primary runtime checkpoint
...
| Actual target error | `column mv.meeting_id does not exist` |
...
The new `meeting_id` error is **not** reclassified as HMD-009, **not** allocated as HMD-010, and **not** repaired in this task.

---

## 15. New failure observation
...
| New HMD allocated | **NO** (`HMD-010` **NOT ALLOCATED**) |
...
## 16. Bounded sanitized process output
...
- `[e02-guard] evidenceRunId=local-016-20260830a env=local projectRef=127.0.0.1 host=127.0.0.1:54321`
- `[bcr-replay] manifest written: …\tests\e02\evidence\local-016-20260830a\bcr-replay-manifest.json`
...
## 17. RU-1.1 / RU-1.2 / preserve / verifier
...
**Do not** retry LOCAL-016. **Do not** create LOCAL-017 automatically. **Do not** edit `20260405120000_multi_tenant_properties.sql`. **Do not** edit `20260405115900_hmd009_reconstruct_hiring_jobs.sql`. **Do not** edit the HMD-008 target. **Do not** edit the HMD-007 target. **Do not** edit the HMD-006 target. **Do not** edit HMD-005 reconstruction or target. **Do not** edit W1/W2. **Do not** expand quarantine. **Do not** issue `E-02-RU-1.4-REA`. **Do not** run the baseline verifier. **Do not** kill processes. **Do not** remap Studio. **Do not** allocate HMD-010 in this task.

Potential new HMD allocation for the `20260405120000` `column mv.meeting_id does not exist` error is a **later governance decision**. This evidence task does **not** allocate it.

---

## 21. Confirmation of no unauthorized work

**`--apply` ran exactly once.** No second apply. No source/migration/HMD-009 reconstruction/target/HMD-008 target/HMD-007 target/HMD-006 target/HMD-005 reconstruction/target/W1/W2/HMD-002/HMD-004/July S1/verifier/guard/package/test change during this runtime task. No process kill. No port remap. No RU-1.2 RPC. No RU-1.4. No REA. No EIR. No Acceptance. No Certification. No commit.
...
HMD-009 TARGET                             = REACHED / NOT APPLIED
NEW FAILURE 20260405120000                 = NOT CLASSIFIED / NOT REPAIRED / HMD-010 NOT ALLOCATED
...
**End of document — E-02-DBA-LOCAL-016 Evidence — v1.0 — 2026-08-30**
