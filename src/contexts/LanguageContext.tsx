...
const translations: Record<string, Record<Language, string>> = {
  ...
  procurement_title: { en: 'Procurement Authorization', zh: '采购授权' },
  procurement_new_job: { en: 'New Authorization Request', zh: '新建授权申请' },
  procurement_job_title: { en: 'Job Title', zh: '任务标题' },
  procurement_description: { en: 'Description', zh: '描述' },
  procurement_budget: { en: 'Estimated Authorization Amount', zh: '预计授权金额' },
  procurement_status: { en: 'Status', zh: '状态' },
  procurement_quotes: { en: 'Quotes & Authorization Basis', zh: '报价与授权依据' },
  procurement_add_quote: { en: 'Upload Quote / Authorization Materials', zh: '上传报价/授权资料' },
