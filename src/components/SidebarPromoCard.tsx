...
export function SidebarPromoCard({ language }: SidebarPromoCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex justify-center [@media(max-height:820px)]:mt-1.5 [@media(max-height:720px)]:mt-1">
        {!resolved ? (
          <div
            className="flex h-[118px] w-[118px] items-center justify-center rounded-lg bg-gray-50 ring-1 ring-gray-200"
            aria-busy
          ...
          <div className="rounded-lg bg-white p-2 ring-1 ring-gray-200">
            <QRCode value={inviteUrl} size={118} />
          </div>
        ) : null}
      </div>
    </div>
