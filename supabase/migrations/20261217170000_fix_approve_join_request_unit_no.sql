-- Fix approve_join_request_final: join_requests column is unit_no, not unit_number (42703).
...
COMMENT ON FUNCTION public.approve_join_request_final(uuid, uuid, text) IS
  ...
  'Uses join_requests.unit_no; auto-creates missing profiles from join_requests.full_name / email.';
