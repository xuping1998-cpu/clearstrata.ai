/*
  生产补齐：预算首页 Dashboard RPC（与前端 dashboardApi.ts 一致）

  参数签名（PostgREST / supabase-js）：
  ...
  来源：
    - summary / categories / trend：20260611120000_budget_package_fiscal_year_rpc.sql §9
    - alerts：20260612120000_invoice_budget_lock_category_anomaly.sql（最新 alerts 逻辑）
*/
...
-- ---------------------------------------------------------------------------
-- dashboard_budget_alerts（与 20260612120000 一致）
-- ---------------------------------------------------------------------------
