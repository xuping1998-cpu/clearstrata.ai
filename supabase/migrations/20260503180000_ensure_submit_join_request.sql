-- Ensure public.submit_join_request exists (fixes PostgREST: "Could not find the function ... in the schema cache").
-- Matches frontend: p_property_id, p_requested_role, p_unit_number, p_note, p_full_name, p_email, p_phone, p_invite_code.

-- Prerequisites used by INSERT / checks
ALTER TABLE public.properties
  ADD COLUMN IF NOT EXISTS allow_public_join_requests boolean NOT NULL DEFAULT true;
...
-- Drop legacy overloads so a single canonical signature remains
