...
CREATE INDEX IF NOT EXISTS idx_task_comments_property ON public.task_comments(property_id);

COMMENT ON TABLE public.task_comments IS '任务详情：评论、审批备注、业委会反馈、物业经理说明';
